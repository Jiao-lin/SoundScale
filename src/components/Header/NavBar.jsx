  ...
  return (
    <header>
      <nav className='w-full h-14 bg-zinc-900 grid grid-rows-1 justify-items-start items-center lg:grid-cols-12 grid-cols-9'>
        ...
        <button className={NavBarResponsive.Sm+" "+NavBarResponsive.Xl+" hidden lg:flex hover:text-violet-500 hover:shadow-violet-500 active:text-violet-500"}><p className='hidden md:inline'>GENEROS</p>{iconos.flecha}</button>
        <button className={NavBarResponsive.Sm+" "+NavBarResponsive.Xl+" hidden lg:flex hover:text-violet-500 hover:shadow-violet-500 active:text-violet-500"}><p className='hidden md:inline'>TIPOS</p>{iconos.flecha}</button>
        <button className={NavBarResponsive.Sm+" "+NavBarResponsive.Xl+" hidden lg:flex hover:text-pink-500 hover:shadow-pink-500 active:text-pink-500"}><p className='hidden md:inline'>FAVORITOS</p>{iconos.corazon}</button>
        <CartWidget num={0}/>
