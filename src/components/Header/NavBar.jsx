...
const NavBarBotonesCss= "w-fit place-self-center items-center grid-cols-2 flex flex-row text-white font-sans font-medium tracking-wide text-sm subpixel-antialiased gap-x-1 hover:text-shadow";

export const NavBar = () => {
  return (
    <header>
      <nav className='w-full h-14 bg-zinc-900 grid grid-cols-12 grid-rows-1 justify-items-start	items-center '>
