  ...
  return (
    <header>
      <nav className='w-full h-14 border-b border-zinc-800 bg-neutral-900 grid grid-rows-1 justify-items-start items-center lg:grid-cols-12 grid-cols-9'>
        ...
        <div className='hidden rounded-sm border border-zinc-700 cursor-default h-24 w-1/5 absolute top-12 right-auto bg-zinc-800 group-hover:inline'>
        <ul className='flex ml-2 mt-3 cursor-pointer text-white font-normal text-shadow-none shadow-none'>
        <Link to={`/Category/Electronica`}><li>Electronica</li></Link></ul></div></button>
